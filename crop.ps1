...
[int]$newWidth = [math]::Floor($width * 0.70)
[int]$newHeight = [math]::Floor($height * 0.70)
...
$bmp.Save('c:\Users\Rafa\Downloads\appparaescola\Drika catalogo\images\jaleco_cropped.png', [System.Drawing.Imaging.ImageFormat]::Png)
$graphics.Dispose()
$bmp.Dispose()
$img.Dispose()
